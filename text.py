        ...
        try:
            ...
            with transaction.atomic():
                ...
                if seller_id:
                    ...
                    fractional_units = models.FractionalUnits.objects.filter(current_owner=seller.buyer.user , sold = True)
                    fractional_unitsCount = fractional_units.count()
                    ...
                    if fractional_unitsCount < no_of_partition :
                        return JsonResponse({"message": "Not enough fractional units available"}, status=400)
                    ...
                    fractional_units = models.FractionalUnits.objects.filter(current_owner=NULL , sold = False)
                    fractional_unitsCount = fractional_units.count()
