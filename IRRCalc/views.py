...
from .Balloon_Interest_Only import calculate_BallonInterestOnlyBuyer_price_to_XIRR , calculate_BalloonInterestOnlySeller_XIRR_to_price , calculate_BalloonInterestOnlySeller_price_to_XIRR
from .fixed_price import calculate_Fixedbuyer_price_to_XIRR , calculate_FixedSeller_price_to_XIRR , calculate_FixedSeller_XIRR_to_price
from .Declining_Principal import calculate_DecliningBuyer_price_to_XIRR , calculate_DecliningSeller_price_to_XIRR , calculate_DecliningSeller_XIRR_to_price
from .Balloon_Loan_Principal import calculate_BaloonPrincipalBuyer_price_to_XIRR , calculate_BalloonPrinipalSeller_price_to_XIRR , calculate_BalloonPrincipalSeller_XIRR_to_price
import json 
        ...
        try:
            ...
            if type == "BUYER":
                dates, amounts, xirr_value = calculate_Fixedbuyer_price_to_XIRR(
                    fractional_unit_value , loan_amount, num_fractions, annual_interest_rate, total_installments, 
                    units_bought, loan_period_years ,disbursed_date, first_payment_date, payment_frequency
                )
                payments = [
                    {
                        "payment_number": i,
